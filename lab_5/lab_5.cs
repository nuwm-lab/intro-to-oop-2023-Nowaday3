...
namespace lab5
{
    ...
    public class ThreeLinearInequalitiesSystem : LinearInequalitiesSystem
    {
        ...
        public override bool CheckSolution(double x1, double x2)
        {
            Console.WriteLine("Перевірка рішення.");
            return base.CheckSolution(x1, x2);
        }
    ...
    public class Program
    {
        public static void Main()
        {
            ...
            LinearInequalitiesSystem system;
